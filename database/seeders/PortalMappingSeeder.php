...
class PortalMappingSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $typeMappings = [
            'apartamento'    => ['ml' => 'MCO1473', 'fr' => 'APT',   'cc' => '10', 'pp' => 'apartment'],
            'apartaestudio'  => ['ml' => 'MCO1473', 'fr' => 'APT',   'cc' => '29', 'pp' => 'studio'],
            'casa'           => ['ml' => 'MCO1468', 'fr' => 'HOUSE', 'cc' => '11', 'pp' => 'house'],
            'casa-campestre' => ['ml' => 'MCO1468', 'fr' => 'HOUSE', 'cc' => '11', 'pp' => 'country-house'],
        ...
        foreach ($barrios as $n) {
            if ($ml) PortalMapping::firstOrCreate(
